 ...
 *                   Uses WiFiManager - see:  https://github.com/tzapu/WiFiManager
 *
 *
 *      I use this sketch as the starting point for most of my ESP based projects.   It is the simplest way
 *      I have found to provide a basic, easily modified  web page displaying updating information, control buttons etc..
 *      It also has the ability to retrieve a web page as text (see: requestWebPage in wifi.h).
 *      For a more advanced examples see:
 ...
 ********************************************************************************************************************
 ...
 Handy way to try out your C++ code: https://coliru.stacked-crooked.com/    or    https://wokwi.com

 GPIO pin info:  esp32: https://lastminuteengineers.com/esp32-pinout-reference/
               esp8266: https://lastminuteengineers.com/esp8266-pinout-reference/
...
// ESP32 gpio pins: https://linuxhint.com/esp32-pinout-reference/
  ...
  const char* sversion = "06Nov23";                      // version of this sketch
