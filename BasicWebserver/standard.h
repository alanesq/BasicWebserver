/**************************************************************************************************
 *
 *      Procedures (which are likely to be the same for all projects) - 24oct23
 *
...
// @param   adnlStyle any additional style to be included
// @param   refresh   enable page auto refreshing (1 or 0)
...
*/
 ...
 // The below line is the above compacted via https://www.textfixer.com/html/compress-html-compression.php
